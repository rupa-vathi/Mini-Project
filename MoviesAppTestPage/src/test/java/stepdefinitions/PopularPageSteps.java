...
public class PopularPageSteps {
    ...
    public void click_on_movie(){
        if(popularPage.checkMoviesDisplay(5)){
            ...
            Assert.assertEquals(driver.getCurrentUrl(),"https://qamoviesapp.ccbp.tech/movies/284a2caa-59d4-46b4-88bc-31a0eb07f622","redirect to movies details page in papular page failed");
        }
    }
}
