...
public class AccountPageSteps {
    ...
    public void TestAccountPageUI(){
        ...
        Assert.assertEquals(accountPage.getHeadOfMemberShip(),"Member ship","Member ship heading not found");
        Assert.assertEquals(accountPage.getMemberShipDetails(),"User name : rahul"+" , " +"Password : **********","Membership details not found");
        Assert.assertEquals(accountPage.getPlanDetails(),"Plan details" + " : " + "Premium" + ", " + "Ultra HD");
    }
